          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">TMC Overdue Loan List</h4>
                </div>
              </div>
            </div>
          </div>
...
$date = date('Y-m-d');
$query = "SELECT * FROM application WHERE repaymentDate <= '$date' AND paid_back = 0";
...
<div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Comprehensive list of overdue loans</h4>
