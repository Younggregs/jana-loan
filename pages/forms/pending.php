          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">TMC Pending List</h4>
                </div>
              </div>
            </div>
          </div>
...
if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])){
  ...
  $query = "UPDATE application SET pending = 0, paid_out = 1 WHERE id = $id";
...
$query = "SELECT * FROM application WHERE pending = 1";
...
<div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Comprehensive list of pending loans</h4>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr class="table-info">
                          ...
                          <td>
                            <a href='pending.php?id=<?php echo $row["id"];?>'>
                              <div class="col-sm-6 col-md-4 col-lg-3">  pay out <i class="ti-credit-card"></i></div>
                            </a>
                          </td>
                        </tr>
                            <option></option>
