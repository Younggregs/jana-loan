        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">TMC Paid Out Loan List</h4>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Paid Out</h4>
...
if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])){
  ...
  $query = "UPDATE application SET paid_back = 1 WHERE id = $id";
      if(mysqli_query($con, $query)){
        ?> <p style="color: green; fontWeight: bold;"> <?php echo 'Application record updated successfully'; ?> </p> <?php
      }else{
...
$query = "SELECT * FROM application WHERE paid_out = 1 AND paid_back=0";
...
<div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Comprehensive list of paid out loans</h4>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr class="table-warning">
                          ...
                          <td>
                            <?php echo $row["repaymentAmount"]; ?>
                          </td>
                          <td>
                            <?php echo $row["repaymentDate"]; ?>
                          </td>
                          <td>
                            <a href='paid_out.php?id=<?php echo $row["id"];?>'>
                              <div class="col-sm-6 col-md-4 col-lg-3">  paid back <i class="ti-credit-card"></i></div>
                            </a>
                          </td>
                        </tr>
                            <option></option>
